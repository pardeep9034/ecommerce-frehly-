        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted">
              ...
              <th className="px-5 py-3.5 text-left font-medium text-muted-foreground sm:px-6">Variants</th>
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id} className="border-b border-border transition-colors last:border-0 hover:bg-muted">
                ...
                <td className="px-5 py-4 text-muted-foreground sm:px-6">{product?.category?.name}</td>
                <td className="px-5 py-4 sm:px-6">
