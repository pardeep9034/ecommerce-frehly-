    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative" onClick={(e) => e.stopPropagation()}>
                <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-success/50">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div>
                        ...
                        {isLoading ? (
                            ...
                            <select
                                ...
                                required
                                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-success bg-white"
                            >
                    ...
                    <div className="flex gap-4 pt-4 border-t border-gray-100">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-2 bg-success text-white rounded-xl hover:bg-success transition duration-200 font-medium disabled:opacity-50 flex justify-center items-center"
                        >
