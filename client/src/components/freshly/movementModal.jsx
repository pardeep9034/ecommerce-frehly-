...
const {variants}=useVariant(form.product_id);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={onSubmit} className="space-y-4 p-6">
           ...
           <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              <label className="text-sm font-medium text-[#1f2937]" htmlFor="variant">
                variant
              </label>
              <SearchableSelector
          ...
          <div>
            ...
            <div>
              <label className="text-sm font-medium text-[#1f2937]" htmlFor="movement_type">
                movement type
              </label>
              <SearchableSelector
         ...
         {form.movement_type!=="ADJUSTMENT"&&
          <div>
            <label className="text-sm font-medium text-[#060a0f]" htmlFor="quantity">
              Quantity
            </label>
            <input
              id="quantity"
      ...
      {form.movement_type==="ADJUSTMENT"&&
          ...
          <div>
            <label className="text-sm font-medium text-[#1f2937]" htmlFor="after_Stock">
              quantity
            </label>
            <input
              id="after_Stock"
          ...
          <div>
            <label className="text-sm font-medium text-[#1f2937]" htmlFor="reason">
              Reason
            </label>
            <input
              id="reason"
