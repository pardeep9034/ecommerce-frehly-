    ...
    <section className="w-full  sm:py-2 lg:py-5">
      <div className="mx-auto max-w-screen-2xl px-2 sm:px-4 lg:px-4">
        <div className="grid grid-cols-2 gap-2 lg:grid-cols-3 lg:gap-2">
          ...
          {/* Main Hero Card */}
          <div className="relative group overflow-hidden rounded-[2rem] sm:rounded-[3rem] bg-linear-to-br from-primary to-success p-4 sm:p-8 lg:p-8 lg:col-span-2 min-h-[150px] sm:min-h-[350px] lg:min-h-[450px] flex flex-col justify-center shadow-2xl shadow-success/20 transition-all duration-500 hover:shadow-success/30">
            ...
            <div className="relative z-10 max-w-l mb-2 sm:mb-4">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-6 sm:mb-10">
                <div className="flex flex-col border-l-2 sm:border-l-4 border-yellow-300 pl-4 sm:pl-6">
                  ...
                  <p className="text-[8px] sm:text-sm text-success font-bold opacity-80 line-clamp-1">Free express shipping on all orders</p>
                </div>
              </div>
  
              <Link 
                to="/shop" 
                className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-4 py-2 sm:px-10 sm:py-5 text-xs sm:text-sm font-black text-primary shadow-2xl transition-all hover:scale-105 hover:bg-yellow-300 active:scale-95 group/btn"
              >
                Shop Now
          ...
          <div className="grid grid-cols-1 gap-3 lg:flex lg:flex-col lg:justify-between h-full">
            ...
            {/* Offer 2 */}
            <div className="relative group overflow-hidden rounded-[2rem] sm:rounded-[3rem] bg-foreground p-5 sm:p-8 lg:p-10 flex flex-col justify-between shadow-xl min-h-[120px] sm:min-h-[250px] bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] transition-all duration-500 hover:scale-[1.03]">
               ...
               <Link 
                to="/shop" 
                className="relative z-10 inline-flex items-center gap-1.5 self-start rounded-full bg-yellow-400/20 px-2 py-1 sm:px-6 sm:py-2.5 text-[8px] sm:text-xs font-black text-yellow-400 backdrop-blur-md border border-yellow-400/20 hover:bg-yellow-400 hover:text-foreground transition-all group/link"
               >
                  Explore
                  <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 transition-transform group-hover/link:translate-x-1" />
               </Link>
