      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 flex items-end justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-md font-black text-foreground sm:text-4xl tracking-tighter">Hot Deals</h2>
              <p className="mt-1 text-xs font-bold text-muted-foreground">Freshly picked savings just for you.</p>
            </div>
          </div>
          <Link 
            to="/shop" 
