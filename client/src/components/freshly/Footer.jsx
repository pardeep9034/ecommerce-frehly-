        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 text-2xl font-black text-primary uppercase tracking-tighter">
              <Leaf className="h-8 w-8 fill-primary" />
              freshly
            </Link>
            ...
            <div className="mt-8 flex gap-4">
              {[Instagram, Facebook, Twitter, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="flex h-10 w-10 items-center justify-center rounded-lg border border-gray-100 text-gray-400 transition-colors hover:border-primary hover:text-primary">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Privacy Policy', 'Terms of Service', 'Shipping Policy', 'Refund Policy'].map((item) => (
                <li key={item}>
                  <Link to="#" className="text-sm font-medium text-gray-500 transition-colors hover:text-primary">
                    {item}
                  </Link>
                </li>
              ))}
