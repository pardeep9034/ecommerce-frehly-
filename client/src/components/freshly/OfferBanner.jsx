...
export const OfferBanner = () => {
  return (
    <section className="w-full bg-muted py-6 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[4rem] bg-foreground px-8 py-12 sm:px-16 sm:py-16 bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] shadow-2xl transition-all duration-500 hover:shadow-black/20">
          {/* Glow effect */}
          ...
          <div className="absolute left-0 bottom-0 h-[20rem] w-[20rem] -translate-x-1/3 translate-y-1/3 rounded-full bg-primary/20 blur-[100px]"></div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-between gap-12 lg:flex-row">
            ...
            <Link 
              to="/shop" 
              className="flex h-12 items-center justify-center gap-4 rounded-full bg-yellow-400 px-12 text-xs font-black text-foreground transition-all hover:bg-white hover:scale-105 active:scale-95 shadow-2xl shadow-yellow-400/20 group group/btn"
            >
