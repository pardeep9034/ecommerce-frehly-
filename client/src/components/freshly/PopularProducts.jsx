...
export const PopularProducts = () => {
    ...
    if (error) {
        return (
          <div className="mx-auto max-w-screen-2xl px-4 py-12 text-center text-destructive font-medium">
    ...
    <section className="w-full py-4 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-end justify-between">
          <div>
            <h2 className="text-sm font-black text-foreground sm:text-4xl tracking-tight">Popular Products</h2>
            <div className="mt-1.5 h-1 w-8 rounded-full bg-success"></div>
          </div>
          <Link 
            to="/shop" 
            className="group flex items-center gap-1 text-[10px] font-black text-primary hover:text-success transition-all"
          >
            View All
