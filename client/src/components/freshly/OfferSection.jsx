        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
          {offers.map((offer) => (
            ...
            >
              ...
              <Link 
                to="/shop" 
                className="relative z-10 inline-flex items-center justify-center gap-2 self-start rounded-full bg-white px-3 py-1 sm:px-8 sm:py-3.5 text-[8px] sm:text-[10px] font-black text-primary hover:bg-yellow-300 transition-all group/link shadow-xl"
              >
                Explore
