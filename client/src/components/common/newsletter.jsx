...
export const Newsletter = () => {
  ...
  return (
    <section className="w-full bg-[#f8fafc] py-10 lg:py-15">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[4rem] bg-[#0f5132] px-6 py-10 sm:px-16 sm:py-20 lg:flex lg:items-center lg:justify-between shadow-2xl shadow-green-900/40 transition-all duration-500 hover:shadow-green-900/50">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <p className="mt-8 text-sm font-bold text-green-100/80 leading-relaxed max-w-lg md:text-base">
          ...
          <div className="relative z-10 mt-8 lg:mt-0 lg:ml-12 w-full max-w-md">
            {subscribed ? (
              <div className="flex items-center gap-4 rounded-[2.5rem] bg-white p-6 text-[#0f5132] animate-in zoom-in duration-500 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:flex-row sm:items-center sm:bg-white sm:rounded-full sm:p-2 sm:shadow-2xl">
                <input
                  ...
                  className="w-full rounded-full border-none bg-white px-6 py-3 text-xs font-black text-[#1f2937] placeholder:text-gray-400 focus:ring-0 sm:bg-transparent sm:py-3"
                />
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 rounded-full bg-[#0f5132] px-6 py-3 text-xs font-black text-white transition-all hover:bg-yellow-400 hover:text-[#0f5132] hover:scale-105 active:scale-95 shadow-xl sm:py-2 sm:px-8"
                >
                  Join Now
            ...
            <p className="mt-6 text-[10px] md:text-sm font-bold text-green-100/40 text-center lg:text-left tracking-widest uppercase">
