    ...
    <section className="w-full bg-white py-10 lg:py-20 overflow-hidden relative">
      ...
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-20 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full bg-[#0f5132]/5 px-4 py-2 text-[8px] font-black uppercase tracking-widest text-[#0f5132] mb-6">
            <Star className="h-4 w-4 fill-[#0f5132]" />
            Customer Stories
          </div>
          <h2 className="text-3xl font-black text-[#1f2937] sm:text-6xl tracking-tighter leading-none mb-6">
            What Our Community <span className="text-[#16a34a] italic underline decoration-[12px] underline-offset-[12px]">Say</span>
          </h2>
          <p className="mt-10 text-lg text-[#6b7280] font-bold leading-relaxed">
        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div 
              key={testimonial.id} 
              className="relative flex flex-col rounded-[3.5rem] bg-white p-2 border border-gray-100 shadow-2xl shadow-gray-200/50 transition-all duration-700 hover:-translate-y-3 hover:shadow-green-900/10 group"
            >
              <div className="absolute -right-6 -top-6 opacity-5 group-hover:opacity-10 transition-all duration-700 group-hover:scale-125">
                <Quote className="h-12 w-12 text-[#0f5132]" />
              </div>
              ...
              <p className="mb-10 flex-1 text-sm font-bold italic leading-relaxed text-[#4b5563]">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-xs font-black text-[#1f2937] tracking-tight">{testimonial.name}</h3>
                  <p className="text-[6px] font-black text-[#16a34a] uppercase tracking-[0.2em]">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
