                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="border-b border-border bg-muted">
                            <tr>
                                <th className="px-5 py-3.5 font-medium text-muted-foreground">Product</th>
                                <th className="px-5 py-3.5 font-medium text-muted-foreground">Promotion</th>
                                <th className="px-5 py-3.5 font-medium text-muted-foreground">Discount</th>
                                <th className="px-5 py-3.5 font-medium text-muted-foreground">Original Price</th>
                                <th className="px-5 py-3.5 font-medium text-muted-foreground">Promo Price</th>
                                        ...
                                        <tr key={item.id} className="transition-colors hover:bg-muted">
                                            ...
                                            <td className="p-4 text-right">
                                                <button
                                                    ...
                                                    className="p-2 text-destructive hover:bg-destructive rounded-lg transition-colors"
