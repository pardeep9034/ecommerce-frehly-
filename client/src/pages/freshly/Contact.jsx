    ...
    <div className="min-h-screen bg-muted">
      ...
      <section className="bg-primary py-20 text-center text-white">
        <div className="mx-auto max-w-7xl px-4">
           <span className="inline-block rounded-full bg-white/10 px-4 py-1 text-xs font-bold uppercase tracking-widest text-accent">
             Contact Us
           </span>
           <h1 className="mt-4 text-4xl font-black sm:text-5xl">We'd Love to <span className="text-accent">Hear From You</span></h1>
            ...
            <div className="rounded-2xl bg-primary p-8 text-white shadow-xl shadow-primary/20">
              ...
              <div className="mt-6 flex gap-4">
                {[Instagram, Facebook, Twitter, Linkedin].map((Icon, i) => (
                  <a key={i} href="#" className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 transition-colors hover:bg-accent hover:text-primary">
            ...
            <div className="h-full rounded-2xl border border-gray-100 bg-white p-8 shadow-sm md:p-12">
              {submitted ? (
                <div className="flex h-full flex-col items-center justify-center text-center">
                  <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-success text-success">
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 outline-none transition-all focus:border-primary focus:bg-white focus:ring-4 focus:ring-primary/5"
                          value={formData.name}
                    ...
                    <button 
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-4 text-base font-bold text-white shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] hover:bg-primary/90 disabled:opacity-50"
                    >
                      {isSubmitting ? (
