...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative h-[400px] overflow-hidden bg-primary">
        ...
        <div className="relative mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-4 text-center">
          <span className="mb-4 inline-block rounded-full bg-white/10 px-4 py-1 text-sm font-bold tracking-widest text-accent uppercase">
            Our Journey
          </span>
          <h1 className="text-4xl font-black text-white sm:text-6xl tracking-tight">
            Rooted in <span className="text-accent">Nature</span>, <br />Dedicated to <span className="text-accent">Purity</span>.
          </h1>
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
            <div className="relative">
              <div className="absolute -left-4 -top-4 h-64 w-64 rounded-full bg-primary/5 blur-3xl" />
              <img 
                src="https://images.unsplash.com/photo-1595855759920-86582396756a?q=80&w=800&auto=format&fit=crop" 
                alt="Fresh Harvest" 
                className="relative z-10 rounded-3xl shadow-2xl"
              />
              <div className="absolute -bottom-8 -right-8 z-20 flex flex-col items-center justify-center rounded-2xl bg-accent p-6 text-accent-foreground shadow-xl">
            ...
            <div>
              <h2 className="text-3xl font-black text-gray-900 sm:text-4xl">
                ...
                <span className="text-primary">Bridge the Gap</span> Between <br />
                Farm and Table.
              </h2>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
            {values.map((value, i) => (
              <div key={i} className="group rounded-3xl bg-white p-10 shadow-sm transition-all hover:-translate-y-2 hover:shadow-xl">
                 <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/5 text-primary transition-colors group-hover:bg-primary group-hover:text-white">
