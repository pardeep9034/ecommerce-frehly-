...
import MovementTable from "@/components/freshly/movementTable";
import { useNavigate } from "react-router-dom";
import Pagination from "@/components/common/pagination";
import useStockMovement from "@/hooks/use-stockMovement";
import MovementModal from "@/components/freshly/movementModal";
...
const stockMovement = () => {
  ...
  const { stockMovements,createMutation,isLoading } = useStockMovement(currentPage,1);
